...
class EventGateway {
  constructor (configuration) {
    if (
      ...
      throw new Error("Please provide an object with the property 'url' to the SDK")
    }
    ...
    if (isHosted(configuration.url)) {
      ...
      if (isNil(configuration.apiKey)) {
        throw new Error('apiKey is required for configuring SDK for hosted Event Gateway')
      }
